...
const doors = [
  ...
  { id: 'capital', icon: '◆', title: 'Capital',            subtitle: 'Raise & invest',      desc: 'Post your funding round or browse ideas worth backing. Connecting founders with believers — transactions coming soon.', color: '#4ADE80', colorDim: 'rgba(74,222,128,0.10)',  colorBorder: 'rgba(74,222,128,0.30)',  tag: 'Capital',    path: '/capital' },
  { id: 'journal', icon: '✍', title: 'Journal',            subtitle: 'Think out loud',      desc: 'Write free-form observations, frustrations, and sparks. AI reads your entries and surfaces business ideas hiding in your notes.', color: '#C9A84C', colorDim: 'rgba(201,168,76,0.10)', colorBorder: 'rgba(201,168,76,0.30)', tag: 'Reflect', path: '/journal' },
